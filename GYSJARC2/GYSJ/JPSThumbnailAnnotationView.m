...
- (id)initWithAnnotation:(id<MKAnnotation>)annotation {
    ...
    if (self) {
        ...
        // Name Label
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(-32, 10, 168, 20)];
        _titleLabel.backgroundColor = [UIColor clearColor];
        _titleLabel.textColor =  LabelBgColor;
        ...
        _subtitleLabel.textColor    = LabelBgColor;
        ...
        _disclosureButton.frame = CGRectMake(0, 0, self.frame.size.width, self.frame.size.height);
        [_disclosureButton setBackgroundColor:[UIColor clearColor]];
